          ...
          description={
            <div className="flex max-w-[810px] flex-col gap-5">
              <span className="text-sm">
                This DNS zone is currently hosted by AWS Route 53 and the underlying domain is
                registered at GoDaddy. To use Datum nameservers, you&apos;ll want to visit GoDaddy
                and replace the existing nameservers to match the following:
              </span>
