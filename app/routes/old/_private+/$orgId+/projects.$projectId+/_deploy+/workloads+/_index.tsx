    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          ...
          return isDeleted ? (
            ...
            <Link
              to={getPathWithParams(paths.projects.deploy.workloads.detail.root, {
                orgId,
                projectId,
    ...
    () => [
      {
        ...
        action: (row) => {
          navigate(
            getPathWithParams(paths.projects.deploy.workloads.detail.edit, {
              orgId,
              projectId,
              workloadId: row.name,
            })
  ...
  return (
    <DataTable
        ...
        actions: [
          {
            type: 'link',
            label: 'New Workload',
            to: getPathWithParams(paths.projects.deploy.workloads.new, { orgId, projectId }),
            variant: 'default',
      ...
      tableTitle={{
        ...
        actions: (
          <Link
            to={getPathWithParams(paths.projects.deploy.workloads.new, {
              orgId,
              projectId,
            })}>
            <Button>
