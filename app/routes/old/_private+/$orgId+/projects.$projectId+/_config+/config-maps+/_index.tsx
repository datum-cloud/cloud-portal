    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          return (
            <Link
              to={getPathWithParams(paths.projects.config.configMaps.edit, {
                orgId,
                projectId,
    ...
    () => [
      {
        ...
        action: (row) => {
          navigate(
            getPathWithParams(paths.projects.config.configMaps.edit, {
              orgId,
              projectId,
  ...
  return (
    <DataTable
        ...
        actions: [
          {
            ...
            to: getPathWithParams(paths.projects.config.configMaps.new, { orgId, projectId }),
            variant: 'default',
      ...
      tableTitle={{
        ...
        actions: (
          <Link
            to={getPathWithParams(paths.projects.config.configMaps.new, {
              orgId,
              projectId,
            })}>
            <Button>
