    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          return (
            <Link
              to={getPathWithParams(paths.projects.config.secrets.edit, {
                orgId,
                projectId,
  ...
  const rowActions: DataTableRowActionsProps<ISecretControlResponse>[] = useMemo(
    () => [
      /* {
        ...
        action: (row) => {
          navigate(
            getPathWithParams(paths.projects.config.secrets.edit, {
              orgId,
              projectId,
              secretId: row.name,
            }),
  ...
  return (
    <DataTable
        ...
        actions: [
          {
            type: 'link',
            label: 'New Secret',
            to: getPathWithParams(paths.projects.config.secrets.new, { orgId, projectId }),
            variant: 'default',
      ...
      tableTitle={{
        ...
        actions: (
          <Link
            to={getPathWithParams(paths.projects.config.secrets.new, {
              orgId,
              projectId,
            })}>
            <Button>
