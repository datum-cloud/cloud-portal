...
import { ROUTE_PATH as NETWORKS_ACTIONS_ROUTE_PATH } from '@/routes/old/api+/connect+/networks+/actions';
    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          return (
            <Link
              to={getPathWithParams(paths.projects.connect.networks.detail.overview, {
                orgId,
                projectId,
    ...
    () => [
      {
        ...
        action: (row) => {
          navigate(
            getPathWithParams(paths.projects.connect.networks.detail.edit, {
              orgId,
              projectId,
              networkId: row.name,
            })
  ...
  return (
    <DataTable
        ...
        actions: [
          {
            type: 'link',
            label: 'New Network',
            to: getPathWithParams(paths.projects.connect.networks.new, { orgId, projectId }),
            variant: 'default',
      ...
      tableTitle={{
        ...
        actions: (
          <Link
            to={getPathWithParams(paths.projects.connect.networks.new, {
              orgId,
              projectId,
            })}>
            <Button>
