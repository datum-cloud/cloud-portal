    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          return (
            <Link
              to={getPathWithParams(paths.projects.connect.httpRoutes.edit, {
                orgId,
                projectId,
    ...
    () => [
      {
        ...
        action: (row) => {
          navigate(
            getPathWithParams(paths.projects.connect.httpRoutes.edit, {
              orgId,
              projectId,
              httpId: row.name,
            })
  ...
  return (
    <DataTable
        ...
        actions: [
          {
            ...
            to: getPathWithParams(paths.projects.connect.httpRoutes.new, { orgId, projectId }),
            variant: 'default',
      ...
      tableTitle={{
        ...
        actions: (
          <Link
            to={getPathWithParams(paths.projects.connect.httpRoutes.new, {
              orgId,
              projectId,
            })}>
            <Button>
