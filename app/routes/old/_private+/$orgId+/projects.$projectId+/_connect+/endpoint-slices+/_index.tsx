    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          return (
            <Link
              to={getPathWithParams(paths.projects.connect.endpointSlices.edit, {
                orgId,
                projectId,
    ...
    () => [
      {
        ...
        action: (row) => {
          navigate(
            getPathWithParams(paths.projects.connect.endpointSlices.edit, {
              orgId,
              projectId,
              endpointId: row.name,
            })
  ...
  return (
    <DataTable
        ...
        actions: [
          {
            ...
            to: getPathWithParams(paths.projects.connect.endpointSlices.new, { orgId, projectId }),
            variant: 'default',
      ...
      tableTitle={{
        ...
        actions: (
          <Link
            to={getPathWithParams(paths.projects.connect.endpointSlices.new, {
              orgId,
              projectId,
            })}>
            <Button>
