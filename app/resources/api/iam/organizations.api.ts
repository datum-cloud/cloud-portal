...
export const iamOrganizationsAPI = (client: AxiosInstance) => {
  ...
  return {
    ...
    async create(payload: OrganizationSchema, validate: boolean = false): Promise<IOrganization> {
    ...
    async delete(id: string, validate: boolean = false): Promise<IOrganization | undefined> {
