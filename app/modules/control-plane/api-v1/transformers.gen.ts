...
const ioK8sApiCoreV1EventSeriesSchemaResponseTransformer = (data: any) => {
  if (data.lastObservedTime) {
    data.lastObservedTime = ioK8sApimachineryPkgApisMetaV1MicroTimeSchemaResponseTransformer(
...
const ioK8sApiCoreV1EventSchemaResponseTransformer = (data: any) => {
  ...
  data.metadata = ioK8sApimachineryPkgApisMetaV1ObjectMetaSchemaResponseTransformer(data.metadata);
  if (data.series) {
...
const ioK8sApiAuthenticationV1TokenRequestStatusSchemaResponseTransformer = (data: any) => {
...
const ioK8sApiAuthenticationV1TokenRequestSchemaResponseTransformer = (data: any) => {
  ...
  if (data.status) {
    data.status = ioK8sApiAuthenticationV1TokenRequestStatusSchemaResponseTransformer(data.status);
  }
  return data;
};
