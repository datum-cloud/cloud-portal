...
export const com_miloapis_documentation_v1alpha1_DocumentSchema = {
    ...
    properties: {
        ...
        status: {
            ...
            properties: {
                ...
                latestRevisionRef: {
                    description: 'LatestRevisionRef is a reference to the latest revision of the document.',
                    type: 'object',
                    properties: {
                        name: {
                            type: 'string'
...
export const com_miloapis_documentation_v1alpha1_DocumentListSchema = {
    description: 'DocumentList is a list of Document',
    type: 'object',
    required: [
        'items'
    ],
    properties: {
        ...
        items: {
            description: 'List of documents. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
                $ref: '#/components/schemas/com.miloapis.documentation.v1alpha1.Document'
            }
        },
        kind: {
            description: 'Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
...
export const com_miloapis_documentation_v1alpha1_DocumentRevisionSchema = {
    description: 'DocumentRevision is the Schema for the documentrevisions API.\nIt represents a revision of a document.',
    type: 'object',
    properties: {
        apiVersion: {
            description: 'APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources',
        ...
        spec: {
            ...
            properties: {
                changesSummary: {
                    description: 'ChangesSummary is the summary of the changes in the document revision.',
                    type: 'string'
                },
                content: {
                ...
                documentRef: {
                    description: 'DocumentRef is a reference to the document that this revision is based on.',
                    type: 'object',
                    required: [
                        'name',
                        'namespace'
                ...
                effectiveDate: {
                    description: 'EffectiveDate is the date in which the document revision starts to be effective.',
                    type: 'string',
                    format: 'date-time'
                },
                expectedAccepterKinds: {
                    description: 'ExpectedAccepterKinds is the resource kinds that are expected to accept this revision.',
                    type: 'array',
                    items: {
                        description: 'DocumentRevisionExpectedAccepterKind is the kind of the resource that is expected to accept this revision.',
                        type: 'object',
                        required: [
                            'apiGroup',
                            'kind'
                ...
                expectedSubjectKinds: {
                    description: 'ExpectedSubjectKinds is the resource kinds that this revision affects to.',
                    type: 'array',
                    items: {
                        description: 'DocumentRevisionExpectedSubjectKind is the kind of the resource that is expected to reference this revision.',
                        type: 'object',
                        required: [
                            'apiGroup',
                            'kind'
        ...
        status: {
            ...
            properties: {
                ...
                contentHash: {
                    description: 'ContentHash is the hash of the content of the document revision.\nThis is used to detect if the content of the document revision has changed.',
                    type: 'string'
                }
            }
        }
...
export const com_miloapis_documentation_v1alpha1_DocumentRevisionListSchema = {
    description: 'DocumentRevisionList is a list of DocumentRevision',
    type: 'object',
    required: [
        'items'
    ],
    properties: {
        ...
        items: {
            description: 'List of documentrevisions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
                $ref: '#/components/schemas/com.miloapis.documentation.v1alpha1.DocumentRevision'
            }
        },
        kind: {
            description: 'Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
