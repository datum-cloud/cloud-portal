...
export const io_k8s_api_flowcontrol_v1_FlowSchemaSchema = {
    ...
    properties: {
        ...
        status: {
            ...
            allOf: [
                {
                    $ref: '#/components/schemas/io.k8s.api.flowcontrol.v1.FlowSchemaStatus'
                }
            ]
        }
    },
...
export const io_k8s_api_flowcontrol_v1_FlowSchemaListSchema = {
...
export const io_k8s_api_flowcontrol_v1_PriorityLevelConfigurationSchema = {
    ...
    properties: {
        ...
        spec: {
            ...
            allOf: [
                {
                    $ref: '#/components/schemas/io.k8s.api.flowcontrol.v1.PriorityLevelConfigurationSpec'
                }
            ]
        },
        status: {
            ...
            allOf: [
                {
                    $ref: '#/components/schemas/io.k8s.api.flowcontrol.v1.PriorityLevelConfigurationStatus'
                }
            ]
        }
    },
...
export const io_k8s_api_flowcontrol_v1_PriorityLevelConfigurationListSchema = {
