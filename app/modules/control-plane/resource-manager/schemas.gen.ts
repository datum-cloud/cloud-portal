...
export const com_datumapis_resourcemanager_v1alpha_ProjectSchema = {
  ...
  properties: {
    ...
    spec: {
      ...
      properties: {
        parent: {
          description: "A reference to the project's parent in the resource hierarchy.",
          type: 'object',
          required: ['external'],
          properties: {
            external: {
              description: `External is a reference to the parent of the project. Must be a valid
resource name.`,
              type: 'string',
            },
          },
...
This field may not be empty.`,
  ...
  'x-kubernetes-group-version-kind': [
    {
      group: 'resourcemanager.datumapis.com',
      kind: 'Project',
      version: 'v1alpha',
    },
  ],
...
export const com_datumapis_resourcemanager_v1alpha_ProjectListSchema = {
  ...
  properties: {
    ...
    items: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/com.datumapis.resourcemanager.v1alpha.Project',
      },
    },
    kind: {
      description:
