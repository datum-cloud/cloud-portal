...
export const deleteResourcemanagerDatumapisComV1AlphaCollectionProjectResponseTransformer = async (
  data: any
...
const comDatumapisResourcemanagerV1AlphaProjectSchemaResponseTransformer = (data: any) => {
  if (data.metadata) {
...
const comDatumapisResourcemanagerV1AlphaProjectListSchemaResponseTransformer = (data: any) => {
...
export const readResourcemanagerDatumapisComV1AlphaProjectStatusResponseTransformer = async (
  data: any
...
export const patchResourcemanagerDatumapisComV1AlphaProjectStatusResponseTransformer = async (
  data: any
...
export const replaceResourcemanagerDatumapisComV1AlphaProjectStatusResponseTransformer = async (
  data: any
