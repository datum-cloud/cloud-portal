...
>(
  options?: Options<DeleteResourcemanagerDatumapisComV1AlphaCollectionProjectData, ThrowOnError>
) => {
 ...
 */
export const listResourcemanagerDatumapisComV1AlphaProject = <ThrowOnError extends boolean = false>(
 ...
 */
export const readResourcemanagerDatumapisComV1AlphaProject = <ThrowOnError extends boolean = false>(
...
export const patchResourcemanagerDatumapisComV1AlphaProjectStatus = <
  ThrowOnError extends boolean = false,
>(
  options: Options<PatchResourcemanagerDatumapisComV1AlphaProjectStatusData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).patch<
    PatchResourcemanagerDatumapisComV1AlphaProjectStatusResponse,
    unknown,
...
export const replaceResourcemanagerDatumapisComV1AlphaProjectStatus = <
  ThrowOnError extends boolean = false,
>(
  options: Options<ReplaceResourcemanagerDatumapisComV1AlphaProjectStatusData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).put<
    ReplaceResourcemanagerDatumapisComV1AlphaProjectStatusResponse,
    unknown,
