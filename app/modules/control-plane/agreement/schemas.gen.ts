...
export const com_miloapis_agreement_v1alpha1_DocumentAcceptanceSchema = {
    description: 'DocumentAcceptance is the Schema for the documentacceptances API.\nIt represents a document acceptance.',
    type: 'object',
    properties: {
        apiVersion: {
        ...
        spec: {
            ...
            properties: {
                acceptanceContext: {
                    ...
                    properties: {
                        acceptanceLanguage: {
                            description: 'AcceptanceLanguage is the language of the document acceptance.',
                            type: 'string'
                        },
                        ipAddress: {
                ...
                accepterRef: {
                    description: 'AccepterRef is a reference to the accepter that this document acceptance applies to.',
                    type: 'object',
                    required: [
                        'apiGroup',
                        'kind',
                ...
                documentRevisionRef: {
                    description: 'DocumentRevisionRef is a reference to the document revision that is being accepted.',
                    type: 'object',
                    required: [
                        'name',
                        'namespace',
                    ...
                    properties: {
                        ...
                        version: {
                            description: 'Version is the version of the DocumentRevision being referenced.',
                            type: 'string',
                            pattern: '^v\\d+\\.\\d+\\.\\d+$'
                        }
                    }
                ...
                signature: {
                    ...
                    properties: {
                        ...
                        type: {
                            description: 'Type specifies the signature mechanism used for the document acceptance.',
                            type: 'string',
                            enum: [
                                'checkbox'
                            ]
                ...
                subjectRef: {
                    description: 'SubjectRef is a reference to the subject that this document acceptance applies to.',
                    type: 'object',
                    required: [
                        'apiGroup',
                        'kind',
...
export const com_miloapis_agreement_v1alpha1_DocumentAcceptanceListSchema = {
    description: 'DocumentAcceptanceList is a list of DocumentAcceptance',
    type: 'object',
    required: [
        'items'
    ],
    properties: {
        ...
        items: {
            description: 'List of documentacceptances. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
                $ref: '#/components/schemas/com.miloapis.agreement.v1alpha1.DocumentAcceptance'
            }
        },
        kind: {
            description: 'Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
