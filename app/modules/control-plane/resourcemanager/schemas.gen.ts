...
export const com_miloapis_resourcemanager_v1alpha1_OrganizationMembershipSchema = {
    ...
    properties: {
        ...
        spec: {
            ...
            properties: {
                organizationRef: {
                    description: 'OrganizationRef identifies the organization to grant membership in.\nThe organization must exist before creating the membership.\n\nRequired field.',
                    type: 'object',
                    required: [
                        'name'
                    ],
                ...
                userRef: {
                    description: 'UserRef identifies the user to grant organization membership.\nThe user must exist before creating the membership.\n\nRequired field.',
                    type: 'object',
                    required: [
                        'name'
                    ],
        ...
        status: {
            ...
            properties: {
                ...
                observedGeneration: {
                    description: 'ObservedGeneration tracks the most recent membership spec that the\ncontroller has processed. Use this to determine if status reflects\nthe latest changes.',
                    type: 'integer',
                    format: 'int64'
                },
                organization: {
                    description: 'Organization contains cached information about the organization in this membership.\nThis information is populated by the controller from the referenced organization.',
                    type: 'object',
                    properties: {
                        displayName: {
                ...
                user: {
                    description: 'User contains cached information about the user in this membership.\nThis information is populated by the controller from the referenced user.',
                    type: 'object',
                    properties: {
                        avatarUrl: {
    ...
    'x-kubernetes-selectable-fields': [
        ...
        {
            fieldPath: 'spec.organizationRef.name'
        }
    ]
} as const;
...
export const com_miloapis_resourcemanager_v1alpha1_OrganizationMembershipListSchema = {
    ...
    properties: {
        ...
        items: {
            description: 'List of organizationmemberships. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
