...
export const com_miloapis_iam_v1alpha1_MachineAccountKeySchema = {
...
This field may not be empty.`,
  ...
  'x-kubernetes-selectable-fields': [
    {
      fieldPath: 'spec.machineAccountName',
    },
  ],
} as const;

export const com_miloapis_iam_v1alpha1_MachineAccountKeyListSchema = {
  description: 'MachineAccountKeyList is a list of MachineAccountKey',
  type: 'object',
  required: ['items'],
  properties: {
    apiVersion: {
    ...
    items: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/com.miloapis.iam.v1alpha1.MachineAccountKey',
      },
    },
    kind: {
      description:
