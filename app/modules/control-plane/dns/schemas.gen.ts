...
export const com_miloapis_networking_dns_v1alpha1_DNSRecordSetSchema = {
    ...
    properties: {
        ...
        spec: {
            ...
            properties: {
                dnsZoneRef: {
                    description: 'DNSZoneRef references the DNSZone (same namespace) this recordset belongs to.',
                    type: 'object',
                    properties: {
                        name: {
                    ...
                    'x-kubernetes-validations': [
                        {
                            rule: 'self.name != \'\'',
                            message: 'dnsZoneRef.name must be set'
                        }
                    ]
                },
                recordType: {
                ...
                records: {
                    ...
                    items: {
                        ...
                        properties: {
                            a: {
                                description: 'Exactly one of the following type-specific fields should be set matching RecordType.',
                                type: 'object',
                                required: [
                                    'content'
                                ],
                            ...
                            alias: {
                                description: 'ALIASRecordSpec is like CNAME but intended for providers that implement an ALIAS/ANAME-style record.\nThe content is a hostname (FQDN or relative) with an optional trailing dot.',
                                type: 'object',
                                required: [
                                    'content'
                                ],
            ...
            properties: {
                ...
                recordSets: {
                    ...
                    items: {
                        ...
                        properties: {
                            conditions: {
                                description: 'Conditions captures per-name readiness information such as RecordProgrammed.',
                                type: 'array',
                                items: {
                                    description: 'Condition contains details for one aspect of the current state of this API Resource.',
                                    type: 'object',
...
export const com_miloapis_networking_dns_v1alpha1_DNSZoneSchema = {
    ...
    properties: {
        ...
        status: {
            ...
            properties: {
                ...
                recordCount: {
                    description: 'RecordCount is the number of DNSRecordSet resources in this namespace that reference this zone.',
                    type: 'integer'
                }
            }
        }
    ...
    'x-kubernetes-selectable-fields': [
        ...
        {
            fieldPath: 'status.domainRef.name'
        }
    ]
} as const;
...
export const com_miloapis_networking_dns_v1alpha1_DNSZoneClassSchema = {
    ...
    properties: {
        ...
        spec: {
            ...
            properties: {
                controllerName: {
                    description: 'ControllerName identifies the downstream controller/backend implementation (e.g., "powerdns", "hickory").',
                    type: 'string'
                },
                defaults: {
                    ...
                    properties: {
                        defaultTTL: {
                            description: 'DefaultTTL is the default TTL applied to records when not otherwise specified.',
                            type: 'integer',
                            format: 'int64'
                        }
                    }
                ...
                nameServerPolicy: {
                    description: 'NameServerPolicy defines how nameservers are assigned for zones using this class.',
                    type: 'object',
                    required: [
                        'mode'
                    ],
                    properties: {
                        ...
                        static: {
                            description: 'Static contains a static list of authoritative nameservers when Mode == "Static".',
                            type: 'object',
                            required: [
                                'servers'
                            ],
...
export const com_miloapis_networking_dns_v1alpha1_DNSZoneClassListSchema = {
    ...
    properties: {
        ...
        items: {
            description: 'List of dnszoneclasses. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
...
export const com_miloapis_networking_dns_v1alpha1_DNSZoneDiscoveryListSchema = {
    ...
    properties: {
        ...
        items: {
            description: 'List of dnszonediscoveries. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
...
export const com_miloapis_networking_dns_v1alpha1_DNSZoneListSchema = {
    ...
    properties: {
        ...
        items: {
            description: 'List of dnszones. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
