...
export const com_miloapis_crm_v1alpha1_NoteSchema = {
    ...
    properties: {
        ...
        spec: {
            ...
            properties: {
                ...
                creatorRef: {
                    description: 'CreatorRef is a reference to the user that created the note.\nDefaults to the user that created the note.',
                    type: 'object',
                    required: [
                        'name'
                    ],
                ...
                followUp: {
                    description: 'FollowUp indicates whether this note requires follow-up.\nWhen true, the note is being actively tracked for further action.',
                    type: 'boolean',
                    default: false
                },
                interactionTime: {
                    description: 'InteractionTime is the timestamp of the interaction with the subject.',
                    type: 'string',
                    format: 'date-time'
                },
                nextAction: {
        ...
        status: {
            ...
            properties: {
                conditions: {
                    description: 'Conditions provide conditions that represent the current status of the Note.',
                    type: 'array',
                    default: [
                        {
    ...
    'x-kubernetes-selectable-fields': [
        {
            fieldPath: 'spec.creatorRef.name'
        },
        {
            fieldPath: 'spec.subjectRef.name'
        },
        {
            fieldPath: 'spec.subjectRef.namespace'
        },
        {
            fieldPath: 'spec.subjectRef.kind'
        },
        {
            fieldPath: 'spec.nextActionTime'
        },
        {
            fieldPath: 'spec.followUp'
        },
        {
            fieldPath: 'status.createdBy'
        }
    ]
} as const;

export const com_miloapis_crm_v1alpha1_NoteListSchema = {
    ...
    properties: {
        ...
        items: {
            description: 'List of notes. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md',
            type: 'array',
            items: {
                $ref: '#/components/schemas/com.miloapis.crm.v1alpha1.Note'
            }
        },
        kind: {
            description: 'Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
