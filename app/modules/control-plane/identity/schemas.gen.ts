...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_ServiceAccountKeySchema = {
  ...
  properties: {
    ...
    spec: {
      ...
      allOf: [
        {
          $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.ServiceAccountKeySpec',
        },
      ],
    },
    status: {
      ...
      allOf: [
        {
          $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.ServiceAccountKeyStatus',
        },
      ],
    },
  },
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_ServiceAccountKeyListSchema = {
  ...
  properties: {
    ...
    items: {
      ...
      items: {
        ...
        allOf: [
          {
            $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.ServiceAccountKey',
          },
        ],
      },
    },
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_ServiceAccountKeySpecSchema = {
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_ServiceAccountKeyStatusSchema = {
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_SessionSchema = {
  type: 'object',
  properties: {
    apiVersion: {
      description:
    ...
    status: {
      ...
      allOf: [
        {
          $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.SessionStatus',
        },
      ],
    },
  },
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_SessionListSchema = {
  type: 'object',
  required: ['items'],
  properties: {
    apiVersion: {
    ...
    items: {
      ...
      items: {
        ...
        allOf: [
          {
            $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.Session',
          },
        ],
      },
    },
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_SessionStatusSchema = {
  description:
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_UserIdentitySchema = {
  description:
  ...
  properties: {
    ...
    status: {
      ...
      allOf: [
        {
          $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.UserIdentityStatus',
        },
      ],
    },
  },
...
export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_UserIdentityListSchema = {
  ...
  properties: {
    ...
    items: {
      ...
      items: {
        ...
        allOf: [
          {
            $ref: '#/components/schemas/com.miloapis.go.milo.pkg.apis.identity.v1alpha1.UserIdentity',
          },
        ],
      },
    },
  ...
  'x-kubernetes-group-version-kind': [
    {
      group: 'identity.miloapis.com',
      kind: 'UserIdentityList',
      version: 'v1alpha1',
    },
  ],
} as const;

export const com_miloapis_go_milo_pkg_apis_identity_v1alpha1_UserIdentityStatusSchema = {
  description:
