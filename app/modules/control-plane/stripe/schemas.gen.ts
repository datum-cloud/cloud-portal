...
export const com_miloapis_billing_stripe_v1alpha1_StripePaymentMethodSchema = {
  description:
  ...
  properties: {
    ...
    spec: {
      description: 'StripePaymentMethodSpec defines the desired state of a StripePaymentMethod.',
      type: 'object',
      required: ['paymentMethodRef'],
      properties: {
        paymentMethodRef: {
          description:
    ...
    status: {
      description: 'StripePaymentMethodStatus defines the observed state of a StripePaymentMethod.',
      type: 'object',
      properties: {
        conditions: {
        ...
        confirmedAt: {
          description: 'ConfirmedAt is the timestamp Stripe confirmed the SetupIntent.',
          type: 'string',
          format: 'date-time',
        },
        failureMessage: {
        ...
        failureReason: {
          description: 'FailureReason / FailureMessage are populated when phase is Failed.',
          type: 'string',
        },
        instrument: {
          description:
        ...
        phase: {
          ...
          type: 'string',
          enum: ['Initializing', 'AwaitingConfirmation', 'Active', 'Failed'],
        },
        setupIntent: {
          description: 'SetupIntent captures the in-flight setup session.',
          type: 'object',
          properties: {
            clientSecret: {
              description:
            ...
            id: {
              description: 'ID is the Stripe SetupIntent identifier (e.g. `seti_…`).',
              type: 'string',
            },
            status: {
              description:
...
export const com_miloapis_billing_stripe_v1alpha1_StripePaymentMethodListSchema = {
  description: 'StripePaymentMethodList is a list of StripePaymentMethod',
  type: 'object',
  required: ['items'],
  properties: {
    apiVersion: {
    ...
    items: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/com.miloapis.billing.stripe.v1alpha1.StripePaymentMethod',
      },
    },
    kind: {
      description:
  ...
  'x-kubernetes-group-version-kind': [
    {
      group: 'stripe.billing.miloapis.com',
      kind: 'StripePaymentMethodList',
      version: 'v1alpha1',
    },
  ],
} as const;

export const com_miloapis_billing_stripe_v1alpha1_StripeProviderConfigSchema = {
  description: 'StripeProviderConfig is the Schema for the stripeproviderconfigs API.',
  type: 'object',
  properties: {
    apiVersion: {
      description:
...
export const com_miloapis_billing_stripe_v1alpha1_StripeProviderConfigListSchema = {
  description: 'StripeProviderConfigList is a list of StripeProviderConfig',
  type: 'object',
  required: ['items'],
  properties: {
    apiVersion: {
    ...
    items: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/com.miloapis.billing.stripe.v1alpha1.StripeProviderConfig',
      },
    },
    kind: {
      description:
