...
| `app/features/edge/dns-records/dns-record-ai-edge-cell.tsx` ("Protect with AI Edge" — cross-resource: gate by the CREATED type) | `httpproxies` / `networking.datumapis.com`      | `project` |
