...
import { useAutosizeTextArea } from '@/components/chat/hooks/useAutosizeTextarea'
              ...
              ? {
                  ...Object.fromEntries(
                    Object.entries(props).filter(
                      ([key]) => !['allowAttachments', 'files', 'setFiles'].includes(key),
                    ),
                  ),
                }
              : {
                  ...Object.fromEntries(
                    Object.entries(props).filter(([key]) => key !== 'allowAttachments'),
                  ),
                })}
          />
