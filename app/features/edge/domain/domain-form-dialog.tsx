  ...
  ({ projectId, onSuccess, onError }, ref) => {
    ...
    return (
      <Form.Dialog
        ...
        title="Add a Domain"
        description="To use a custom domain for your services, you must first verify ownership. This form creates a domain resource that provides the necessary DNS records for verification. Once verified, you can securely use your domain in AI Edge and more."
        schema={domainSchema}
