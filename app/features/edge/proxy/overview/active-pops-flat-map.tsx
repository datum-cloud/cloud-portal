...
export function ActivePopsFlatMap({ regionsWithCoords, hoveredRegion, onHoverRegion }: Props) {
  ...
  return (
    <div className="bg-background relative aspect-[1038/591] w-full overflow-hidden rounded-lg border">
      <svg
